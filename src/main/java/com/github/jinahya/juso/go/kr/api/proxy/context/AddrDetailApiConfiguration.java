...
public class AddrDetailApiConfiguration
        extends _AddrApiConfiguration<AddrDetailApiConfigurationProperties> {
    ...
    public @interface AddrDetailApi {
