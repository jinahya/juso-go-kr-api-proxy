...
@Component
//@Configuration
@ConfigurationProperties(prefix = "juso-go-kr.addrlink.addr-coord-api")
@Setter
@Getter
...
@Slf4j
public class AddrCoordApiConfigurationProperties
        extends _AddrApiConfigurationProperties {

    public static final String REQUEST_URI = "/addrlink/addrCoordApi.do";
